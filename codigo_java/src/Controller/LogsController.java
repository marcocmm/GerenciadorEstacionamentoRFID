...
//        m1.setRFIDLog(rfid);
    ...
    public void alterar (int idLog, int motoristasidMotorista, int veiculosidVeiculo, int destinosidDestino){
        Logs m1 = new Logs(idLog, motoristasidMotorista, veiculosidVeiculo, destinosidDestino);
        try {
        daomot.atualizar(m1);
        } catch (Exception e) {
            System.out.println("Erro "+e);
